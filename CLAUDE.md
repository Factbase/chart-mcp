...
- **Custom domain** — `charts.factbase.org` routes to this Worker via `routes` with `custom_domain: true` in `wrangler.jsonc`; `wrangler deploy` provisions it. (Previously `mcp.factbase.org`, freed up on 2026-06-28.)
